...
train_dataset = dataset_mod(rotate_flag=True, label_dir=labels_train, s1_dir=s1_train)
print(100*'-')
print(f"Number of data samples in training set = {len(train_dataset)}")
print(100*'-')
val_dataset = dataset_mod(rotate_flag=False, label_dir=labels_val, s1_dir=s1_val)
print(f"Number of data samples in validation set = {len(val_dataset)}")
print(100*'-')
test_dataset = dataset_mod(rotate_flag=False, label_dir=labels_test, s1_dir=s1_test)
