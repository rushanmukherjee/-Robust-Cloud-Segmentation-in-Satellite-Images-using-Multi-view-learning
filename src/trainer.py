...
# print(100*'-')
val_dataset = dataset_mod(label_dir=labels_val, s1_dir=s1_val, s2_dir=s2_val)
# print(f"Number of data samples in validation set = {len(val_dataset)}")
# print(100*'-')
test_dataset = dataset_mod(label_dir=labels_test, s1_dir=s1_test, s2_dir=s2_test)
...
metrics_list = [accuracy,precision,recall,f1score,meaniou]
...
mlf_logger = L.loggers.MLFlowLogger(
