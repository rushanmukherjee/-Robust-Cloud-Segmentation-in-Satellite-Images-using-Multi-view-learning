...
class CloudSeg_AllModality_Concat(nn.Module):
    def __init__(
        ...
        super(CloudSeg_AllModality_Concat, self).__init__()
...
def main():
    ...
    arch = CloudSeg_AllModality_Concat()
    input_size = (
    ...
    arch_graph = draw_graph(
        ...
        graph_dir='LR',
        expand_nested=True,
        graph_name='Cloud Seg All Modality Concat',
        save_graph=True,
