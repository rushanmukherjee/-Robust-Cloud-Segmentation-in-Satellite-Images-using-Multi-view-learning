...
class CloudSeg_AllModality_Gated_Dropout(nn.Module):
    def __init__(
        ...
        super(CloudSeg_AllModality_Gated_Dropout, self).__init__()

        ##Pooling Operations
        self.pool = nn.MaxPool2d(kernel_size=2,stride=2)
        
        ##S2 Encoder Operations
        self.S2enc1 = conv_block(ch_in=S2_input_channels,ch_out=16, dropout_rate = dropout_rate)
        self.S2enc2 = conv_block(ch_in=16,ch_out=32, dropout_rate = dropout_rate)
        self.S2enc3 = conv_block(ch_in=32,ch_out=64, dropout_rate = dropout_rate)
        self.S2enc4 = conv_block(ch_in=64,ch_out=128, dropout_rate = dropout_rate)
        self.S2enc5 = conv_block(ch_in=128,ch_out=256, dropout_rate = dropout_rate)
        
        ##S1 Encoder Operations
        self.S1enc1 = conv_block(ch_in=S1_input_channels,ch_out=16, dropout_rate = dropout_rate)
        self.S1enc2 = conv_block(ch_in=16,ch_out=32, dropout_rate = dropout_rate)
        self.S1enc3 = conv_block(ch_in=32,ch_out=64, dropout_rate = dropout_rate)
        self.S1enc4 = conv_block(ch_in=64,ch_out=128, dropout_rate = dropout_rate)
        self.S1enc5 = conv_block(ch_in=128,ch_out=256, dropout_rate = dropout_rate)

        ##Landcover Encoder Operations
        self.LCenc1 = conv_block(ch_in=LC_input_channels,ch_out=4, dropout_rate = dropout_rate)
        self.LCenc2 = conv_block(ch_in=4,ch_out=8, dropout_rate = dropout_rate)
        self.LCenc3 = conv_block(ch_in=8,ch_out=16, dropout_rate = dropout_rate)
        self.LCenc4 = conv_block(ch_in=16,ch_out=32, dropout_rate = dropout_rate)
        self.LCenc5 = conv_block(ch_in=32,ch_out=64, dropout_rate = dropout_rate)

        ##DEM Encoder Operations
        self.DEMenc1 = conv_block(ch_in=DEM_input_channels,ch_out=4, dropout_rate = dropout_rate)
        self.DEMenc2 = conv_block(ch_in=4,ch_out=8, dropout_rate = dropout_rate)
        self.DEMenc3 = conv_block(ch_in=8,ch_out=16, dropout_rate = dropout_rate)
        self.DEMenc4 = conv_block(ch_in=16,ch_out=32, dropout_rate = dropout_rate)
        self.DEMenc5 = conv_block(ch_in=32,ch_out=64, dropout_rate = dropout_rate)

        ##Azimuth Encoder Operations
        self.Azienc1 = conv_block(ch_in=azimuth_input_channels,ch_out=4, dropout_rate = dropout_rate)
        self.Azienc2 = conv_block(ch_in=4,ch_out=8, dropout_rate = dropout_rate)
        self.Azienc3 = conv_block(ch_in=8,ch_out=16, dropout_rate = dropout_rate)
        self.Azienc4 = conv_block(ch_in=16,ch_out=32, dropout_rate = dropout_rate)
        self.Azienc5 = conv_block(ch_in=32,ch_out=64, dropout_rate = dropout_rate)

        ##Water Occurence Encoder Operations
        self.WOenc1 = conv_block(ch_in=wateroccurence_input_channels,ch_out=4, dropout_rate = dropout_rate)
        self.WOenc2 = conv_block(ch_in=4,ch_out=8, dropout_rate = dropout_rate)
        self.WOenc3 = conv_block(ch_in=8,ch_out=16, dropout_rate = dropout_rate)
        self.WOenc4 = conv_block(ch_in=16,ch_out=32, dropout_rate = dropout_rate)
        self.WOenc5 = conv_block(ch_in=32,ch_out=64, dropout_rate = dropout_rate)
...
def main():
    ...
    arch = CloudSeg_AllModality_Gated_Dropout()
    input_size = (
