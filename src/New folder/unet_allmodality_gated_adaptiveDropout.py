...
class CloudSeg_AllModality_Gated_adaptiveDropout(nn.Module):
    def __init__(
        ...
        super(CloudSeg_AllModality_Gated_adaptiveDropout, self).__init__()
        ...
        self.LCenc1 = conv_block(ch_in=LC_input_channels,ch_out=4, dropout_rate=dropout_rates['encoder'][0])
        self.LCenc2 = conv_block(ch_in=4,ch_out=8, dropout_rate=dropout_rates['encoder'][1])
        self.LCenc3 = conv_block(ch_in=8,ch_out=16, dropout_rate=dropout_rates['encoder'][2])
        self.LCenc4 = conv_block(ch_in=16,ch_out=32, dropout_rate=dropout_rates['encoder'][3])
        self.LCenc5 = conv_block(ch_in=32,ch_out=64, dropout_rate=dropout_rates['encoder'][4])

        ##DEM Encoder Operations
        self.DEMenc1 = conv_block(ch_in=DEM_input_channels,ch_out=4, dropout_rate=dropout_rates['encoder'][0])
        self.DEMenc2 = conv_block(ch_in=4,ch_out=8, dropout_rate=dropout_rates['encoder'][1])
        self.DEMenc3 = conv_block(ch_in=8,ch_out=16, dropout_rate=dropout_rates['encoder'][2])
        self.DEMenc4 = conv_block(ch_in=16,ch_out=32, dropout_rate=dropout_rates['encoder'][3])
        self.DEMenc5 = conv_block(ch_in=32,ch_out=64, dropout_rate=dropout_rates['encoder'][4])

        ##Azimuth Encoder Operations
        self.Azienc1 = conv_block(ch_in=azimuth_input_channels,ch_out=4, dropout_rate=dropout_rates['encoder'][0])
        self.Azienc2 = conv_block(ch_in=4,ch_out=8, dropout_rate=dropout_rates['encoder'][1])
        self.Azienc3 = conv_block(ch_in=8,ch_out=16, dropout_rate=dropout_rates['encoder'][2])
        self.Azienc4 = conv_block(ch_in=16,ch_out=32, dropout_rate=dropout_rates['encoder'][3])
        self.Azienc5 = conv_block(ch_in=32,ch_out=64, dropout_rate=dropout_rates['encoder'][4])

        ##Water Occurence Encoder Operations
        self.WOenc1 = conv_block(ch_in=wateroccurence_input_channels,ch_out=4, dropout_rate=dropout_rates['encoder'][0])
        self.WOenc2 = conv_block(ch_in=4,ch_out=8, dropout_rate=dropout_rates['encoder'][1])
        self.WOenc3 = conv_block(ch_in=8,ch_out=16, dropout_rate=dropout_rates['encoder'][2])
        self.WOenc4 = conv_block(ch_in=16,ch_out=32, dropout_rate=dropout_rates['encoder'][3])
        self.WOenc5 = conv_block(ch_in=32,ch_out=64, dropout_rate=dropout_rates['encoder'][4])
        ...
        self.dec_conv5 = conv_block(ch_in=1024,ch_out=128, dropout_rate=dropout_rates['decoder'][0])

        self.dec_upsample4 = up_conv(ch_in=128,ch_out=128)
        self.fusion_mod4 = GatedFusionModule([128,128,128,32,32,32,32])
        self.dec_conv4 = conv_block(ch_in=512,ch_out=64, dropout_rate=dropout_rates['decoder'][1])

        self.dec_upsample3 = up_conv(ch_in=64,ch_out=64)
        self.fusion_mod3 = GatedFusionModule([64,64,64,16,16,16,16])
        self.dec_conv3 = conv_block(ch_in=256,ch_out=32, dropout_rate=dropout_rates['decoder'][2])

        self.dec_upsample2 = up_conv(ch_in=32,ch_out=32)
        self.fusion_mod2 = GatedFusionModule([32,32,32,8,8,8,8])
        self.dec_conv2 = conv_block(ch_in=128,ch_out=16, dropout_rate=dropout_rates['decoder'][3])
...
def main():
    ...
    arch = CloudSeg_AllModality_Gated_adaptiveDropout()
    input_size = (
